...
if ! command -v aircrack-ng &> /dev/null; then
    ...
    sudo pacman -S --noconfirm --needed base-devel libnl openssl ethtool util-linux zlib libpcap sqlite pcre2 hwloc cmocka hostapd wpa_supplicant tcpdump screen iw usbutils pciutils expect aircrack-ng
    aircrack-ng --help
